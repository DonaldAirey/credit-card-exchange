namespace FluidTrade.MiddleTierGenerator
{
    ...
    using FluidTrade.Core.TargetInterface;
	...
	public class MiddleTierGenerator : Microsoft.VisualStudio.Shell.Interop.IVsSingleFileGenerator
	{
		...
		/// <param name="wszDefaultNamespace">The namespace FluidTrade.MiddleTierGenerator the generated code.</param>
			...
			IntPtr[] rgbOutputFileContents, out uint pcbOutput, IVsGeneratorProgress pGenerateProgress)
		{
			...
			dataModelSchema.GeneratorType = typeof(MiddleTierGenerator);
			...
			emptyNamespace.Types.Add(new TargetInterface(dataModelSchema));
