namespace FluidTrade.ExpressionEvaluation
{
	...
	public sealed class ExpressionContext
	{
		...
		public ExpressionContext()
			: this(DefaultExpressionOwner.Instance)
		{
		}
		...
		{
			ExpressionContext context = this.MemberwiseClone() as ExpressionContext;
		...
		private ExpressionParser IdentifierParser
		{
			get
			{
				ExpressionParser parser = MyProperties.GetValue<ExpressionParser>("IdentifierParser");
