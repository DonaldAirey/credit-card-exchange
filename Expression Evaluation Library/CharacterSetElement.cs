namespace FluidTrade.ExpressionEvaluation
{
	...
	internal class CharacterSetElement : Element
	{
		...
		{
			if (object.ReferenceEquals(this, DOT))
			{
				return InDotSet(c);
			}
			else if (object.ReferenceEquals(this, DIGIT) || object.ReferenceEquals(this, NON_DIGIT))
			{
				return InDigitSet(c) != inverted;
			}
			else if (object.ReferenceEquals(this, WHITESPACE) || object.ReferenceEquals(this, NON_WHITESPACE))
			{
				return InWhitespaceSet(c) != inverted;
			}
			else if (object.ReferenceEquals(this, WORD) || object.ReferenceEquals(this, NON_WORD))
			{
		...
		public override string ToString()
		{
			...
			else if (object.ReferenceEquals(this, DIGIT))
			{
				return "\\d";
			}
			else if (object.ReferenceEquals(this, NON_DIGIT))
			{
				return "\\D";
			}
			else if (object.ReferenceEquals(this, WHITESPACE))
			{
				return "\\s";
			}
			else if (object.ReferenceEquals(this, NON_WHITESPACE))
			{
				return "\\S";
			}
			else if (object.ReferenceEquals(this, WORD))
			{
				return "\\w";
			}
			else if (object.ReferenceEquals(this, NON_WORD))
			{
				return "\\W";
			}
