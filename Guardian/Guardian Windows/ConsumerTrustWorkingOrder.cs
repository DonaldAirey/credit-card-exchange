namespace FluidTrade.Guardian.Windows
{
	...
	class ConsumerTrustWorkingOrder : WorkingOrder
	{
		...
		public ConsumerTrustWorkingOrder(WorkingOrderRow workingOrderRow)
			: base(workingOrderRow)
		{

			SecurityRow securityRow = workingOrderRow.SecurityRowByFK_Security_WorkingOrder_SecurityId;
			ConsumerTrustRow consumerTrustRow = securityRow.GetConsumerTrustRows()[0];
			ConsumerRow consumerRow = consumerTrustRow.ConsumerRow;

			this.consumerTrustRowVersion = consumerTrustRow.RowVersion;
			...
			Blotter newParent)
		{
			...
			response = client.MoveConsumerTrustToBlotter(newParent.BlotterId, records);
