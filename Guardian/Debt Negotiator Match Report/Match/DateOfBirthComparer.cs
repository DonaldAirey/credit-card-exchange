namespace FluidTrade.Guardian.Schema.DebtNegotiatorMatch
{
	...
	/// </summary>
    public class DateOfBirthComparer : System.Collections.Generic.IComparer<Match>
	{
		...
		public int Compare(Match operand1, Match operand2)
		{
			...
			if ((operand1 != null) && (operand1.DateOfBirth != null) && (operand1.DateOfBirth.DateTime != null))
				operand1DateOfBirth = (DateTime)operand1.DateOfBirth.DateTime;

			if ((operand2 != null) && (operand2.DateOfBirth != null) && (operand2.DateOfBirth.DateTime != null))
