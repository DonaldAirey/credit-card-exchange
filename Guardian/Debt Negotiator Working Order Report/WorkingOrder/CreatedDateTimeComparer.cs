namespace FluidTrade.Guardian.Schema.DebtNegotiatorWorkingOrder
{
	...
	/// </summary>
    public class CreatedDateTimeComparer : System.Collections.Generic.IComparer<WorkingOrder>
	{
		...
		{
            return operand1.CreatedDateTime.DateTime.CompareTo(operand2.CreatedDateTime.DateTime);
		}
