namespace FluidTrade.Guardian.Schema.DebtNegotiatorWorkingOrder
{
	...
	/// </summary>
	public class SavingsBalanceComparer : IComparer<WorkingOrder>
	{
		...
		{
			return ((Decimal)operand1.SavingsBalance.Balance).CompareTo((Decimal)operand2.SavingsBalance.Balance);
		}
