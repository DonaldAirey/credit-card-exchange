namespace FluidTrade.Guardian.Schema.EquityWorkingOrder
{
	...
	/// </summary>
	public class SourceOrderQuantityComparer : System.Collections.Generic.IComparer<WorkingOrder>
	{
		...
		{
			return operand1.SourceOrderQuantity.Quantity.CompareTo(operand2.SourceOrderQuantity.Quantity);
		}
