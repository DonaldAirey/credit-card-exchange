namespace FluidTrade.Guardian.Schema.EquityWorkingOrder
{
	...
	/// </summary>
	public class DestinationOrderQuantityComparer : System.Collections.Generic.IComparer<WorkingOrder>
	{
		...
		{
			return operand1.DestinationOrderQuantity.Quantity.CompareTo(operand2.DestinationOrderQuantity.Quantity);
		}
