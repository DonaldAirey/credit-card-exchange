namespace FluidTrade.Guardian.Schema.CreditCard
{
	...
	/// </summary>
	public class CreditCardIdComparer : IComparer<CreditCard>
	{
		...
		public int Compare(CreditCard operand1, CreditCard operand2)
		{
			...
			Guid operand1Guid = (Guid)operand1.CreditCardId.Text;
			Guid operand2Guid = (Guid)operand2.CreditCardId.Text;
