namespace FluidTrade.Guardian.Schema.ConsumerTrustWorkingOrder
{
	...
	/// </summary>
	public class AvailableQuantityComparer : System.Collections.Generic.IComparer<WorkingOrder>
	{
		...
		{
			return operand1.AvailableQuantity.Quantity.CompareTo(operand2.AvailableQuantity.Quantity);
		}
