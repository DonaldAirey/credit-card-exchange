namespace FluidTrade.Guardian.Schema.DebtHolderPaymentSummary
{
    ...
    /// </summary>
	public class ModifiedDateTimeComparer : System.Collections.Generic.IComparer<PaymentSummary>
    {
        ...
        {
			return ((DateTime)operand1.ModifiedDateTime.Text).CompareTo((DateTime)operand2.ModifiedDateTime.Text);
        }
