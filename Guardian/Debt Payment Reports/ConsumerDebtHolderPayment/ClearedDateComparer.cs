namespace FluidTrade.Guardian.Schema.DebtHolderPaymentSummary
{
    ...
    /// </summary>
	public class ClearedDateComparer : System.Collections.Generic.IComparer<PaymentSummary>
    {
        ...
        {
			return ((DateTime)operand1.ClearedDate.Text).CompareTo((DateTime)operand2.ClearedDate.Text);
        }
