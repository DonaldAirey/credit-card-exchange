namespace FluidTrade.Guardian
{
	...
	/// </summary>
	public partial class ViewerDebtBlotter : Viewer
	{

		// Private Static Fields
		private static ReportDebtWorkingOrder reportWorkingOrder;
		...
		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.AnimationSpeed dependency property.
		/// </summary>
		public static readonly DependencyProperty AnimationSpeedProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.IsFilledFilter dependency property.
		/// </summary>
		public static readonly DependencyProperty IsFilledFilterProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.IsHeaderFrozen dependency property.
		/// </summary>
		public static readonly DependencyProperty IsHeaderFrozenProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.IsLayoutFrozen dependency property.
		/// </summary>
		public static readonly DependencyProperty IsLayoutFrozenProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.IsNavigationPaneVisible dependency property.
		/// </summary>
		public static readonly DependencyProperty IsNavigationPaneVisibleProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.IsRunningFilter dependency property.
		/// </summary>
		public static readonly DependencyProperty IsRunningFilterProperty;

		/// <summary>
		/// Identifies the FluidTrade.FluidTradeClient.ViewerDebtBlotter.Scale dependency property.
		/// </summary>
		public static readonly DependencyProperty ScaleProperty;

		/// <summary>
		/// Create the static resources required for a FluidTrade.FluidTradeClient.ViewerDebtBlotter.
		/// </summary>
		static ViewerDebtBlotter()
		{

			// AnimationSpeed Property
			ViewerDebtBlotter.AnimationSpeedProperty = DependencyProperty.Register(
				"AnimationSpeed",
				typeof(AnimationSpeed),
				typeof(ViewerDebtBlotter),
			...
			ViewerDebtBlotter.IsFilledFilterProperty = DependencyProperty.Register(
				"IsFilledFilter",
				typeof(Boolean),
				typeof(ViewerDebtBlotter),
			...
			ViewerDebtBlotter.IsHeaderFrozenProperty = DependencyProperty.Register(
				"IsHeaderFrozen",
				typeof(Boolean),
				typeof(ViewerDebtBlotter),
			...
			ViewerDebtBlotter.IsLayoutFrozenProperty = DependencyProperty.Register(
				"IsLayoutFrozen",
				typeof(Boolean),
				typeof(ViewerDebtBlotter),
			...
			ViewerDebtBlotter.IsNavigationPaneVisibleProperty = DependencyProperty.Register(
			...
			ViewerDebtBlotter.IsRunningFilterProperty = DependencyProperty.Register(
				"IsRunningFilter",
				typeof(Boolean),
				typeof(ViewerDebtBlotter),
			...
			// Scale Property
			ViewerDebtBlotter.ScaleProperty = DependencyProperty.Register(
				"Scale",
				typeof(Double),
				typeof(ViewerDebtBlotter),
			...
			ViewerDebtBlotter.reportWorkingOrder = new ReportDebtWorkingOrder();
			ViewerDebtBlotter.reportMatch = new ReportMatch();
			ViewerDebtBlotter.reportExecution = new ExecutionReport();
			ViewerDebtBlotter.negotiationConsole = new NegotiationConsole();
		...
		{
			get { return (AnimationSpeed)this.GetValue(ViewerDebtBlotter.AnimationSpeedProperty); }
			set { this.SetValue(ViewerDebtBlotter.AnimationSpeedProperty, value); }
		}
		...
		{
			get { return (Boolean)this.GetValue(ViewerDebtBlotter.IsFilledFilterProperty); }
			set { this.SetValue(ViewerDebtBlotter.IsFilledFilterProperty, value); }
		}
		...
		{
			get { return (Boolean)this.GetValue(ViewerDebtBlotter.IsHeaderFrozenProperty); }
			set { this.SetValue(ViewerDebtBlotter.IsHeaderFrozenProperty, value); }
		}
		...
		{
			get { return (Boolean)this.GetValue(ViewerDebtBlotter.IsLayoutFrozenProperty); }
			set { this.SetValue(ViewerDebtBlotter.IsLayoutFrozenProperty, value); }
		}
		...
		{
			get { return (Boolean)this.GetValue(ViewerDebtBlotter.IsNavigationPaneVisibleProperty); }
			set { this.SetValue(ViewerDebtBlotter.IsNavigationPaneVisibleProperty, value); }
		}
		...
		{
			get { return (Boolean)this.GetValue(ViewerDebtBlotter.IsRunningFilterProperty); }
			set { this.SetValue(ViewerDebtBlotter.IsRunningFilterProperty, value); }
		}
		...
		{
			get { return (Double)this.GetValue(ViewerDebtBlotter.ScaleProperty); }
			set { this.SetValue(ViewerDebtBlotter.ScaleProperty, value); }
		}
		...
		public static void ActivateMatch()
		{
			...
			ViewerDebtBlotter.staticTabControl.SelectedItem = ViewerDebtBlotter.staticMatchTab;
		...
		private void OnCreateSlice(object sender, RoutedEventArgs e)
		{
			...
			if (ViewerDebtBlotter.reportWorkingOrder.Rows != null)
			{

				List<WorkingOrderRow> selectedRows = new List<WorkingOrderRow>();

				foreach (FluidTrade.Core.Windows.Controls.ReportRow reportRow in ViewerDebtBlotter.reportWorkingOrder.Rows)
		...
		private void OnLoaded(object sender, RoutedEventArgs e)
		{
			...
			Console.WriteLine("Loaded Blotter {0}", this.blotter.BlotterId);

			this.tabControl = new TabControl();
			ViewerDebtBlotter.staticTabControl = this.tabControl;
			...
			ViewerDebtBlotter.staticMatchTab = this.tabMatch;
			...
			this.tabExecution.Content = ViewerDebtBlotter.reportExecution;
			...
			this.tabWorkingOrder.Content = ViewerDebtBlotter.reportWorkingOrder;

			this.row1Grid.Children.Add(ViewerDebtBlotter.reportMatch);
			this.row1Grid.Children.Add(ViewerDebtBlotter.negotiationConsole);
			Grid.SetColumn(ViewerDebtBlotter.reportMatch, 0);
			Grid.SetRow(ViewerDebtBlotter.reportMatch, 0);
			Grid.SetColumn(ViewerDebtBlotter.negotiationConsole, 1);
			Grid.SetRow(ViewerDebtBlotter.negotiationConsole, 0);
			this.tabMatch.Content = this.matchGrid;

			// This selects which orders are displayed in the viewer.
			ViewerDebtBlotter.reportWorkingOrder.BlotterId = this.blotter.BlotterId;
			ViewerDebtBlotter.reportMatch.BlotterId = this.blotter.BlotterId;
			ViewerDebtBlotter.reportExecution.BlotterId = this.blotter.BlotterId;
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.AnimationSpeedProperty, bindingAnimationSpeed);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.IsFilledFilterProperty, bindingApplyFilledFilter);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.IsHeaderFrozenProperty, bindingApplyHeaderFrozen);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.IsLayoutFrozenProperty, bindingApplyLayoutFrozen);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.IsNavigationPaneVisibleProperty, bindingIsNavigationPaneVisible);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.IsRunningFilterProperty, bindingApplyRunningFilter);
			...
			BindingOperations.SetBinding(this, ViewerDebtBlotter.ScaleProperty, bindingSliderScale);
		...
		{
			Console.WriteLine("Unloaded Blotter {0}", this.blotter.BlotterId);
			...
			{
				EventLog.Error("Debt Report Unloading before loading.");
				return;
			}
			////End hack.
			...
			this.row1Grid.Children.Remove(ViewerDebtBlotter.reportMatch);
			this.row1Grid.Children.Remove(ViewerDebtBlotter.negotiationConsole);
			...
			// structure.
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.AnimationSpeedProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.IsFilledFilterProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.IsHeaderFrozenProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.IsLayoutFrozenProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.IsNavigationPaneVisibleProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.IsRunningFilterProperty);
			BindingOperations.ClearBinding(this, ViewerDebtBlotter.ScaleProperty);
			...
			DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
		{
			...
			// This takes care of the actual work of setting the filter to display only the filled orders (or removing the filter).
			ViewerDebtBlotter.reportWorkingOrder.IsHeaderFrozen = isHeaderFrozen;
			ViewerDebtBlotter.reportMatch.IsHeaderFrozen = isHeaderFrozen;
			ViewerDebtBlotter.reportExecution.IsHeaderFrozen = isHeaderFrozen;
			...
			DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
		{
			...
			// This takes care of the actual work of setting the filter to display only the filled orders (or removing the filter).
			ViewerDebtBlotter.reportWorkingOrder.IsLayoutFrozen = isLayoutFrozen;
		...
		private void OnSelectColumns(object sender, ExecutedRoutedEventArgs e)
		{
			...
			ViewerDebtBlotter.reportWorkingOrder.SelectColumns();
		...
		private void OnTextBoxSymbolTextChanged(object sender, TextChangedEventArgs e)
		{
			...
			ViewerDebtBlotter.reportWorkingOrder.SymbolFilter = textBox.Text;
