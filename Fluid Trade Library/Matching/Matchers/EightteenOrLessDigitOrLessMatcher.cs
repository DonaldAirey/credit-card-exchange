...
{
	public class EightteenOrLessDigitOrLessMatcher : ColumnFuzzyMatcher
	{
		...
		{
			return new ULongStorage(createArgs);
		}

		public class ULongStorage : FuzzyMatchStorage<UInt64, UInt64>
		{
			protected int probableMatchSetsCount = 15;

			private const ulong TensDigits = 100000000000000000;
			private const ulong TensDigitsPlusOne = 1000000000000000000;
			private const int digitCount = 18;
			...
			*/
			...
			protected override Decimal GetMaskedDataMatchStrength(UInt64 curVal, int maskedDataIndex)
			{
				return ((decimal)probableMatchSets[maskedDataIndex, 4]) / 100M;
			}
			...
			protected override void FillMaskedDataArray(UInt64 curVal, UInt64[] maskedDataArray, out bool[] validAr)
			{
				validAr = null;
				/*					
								999919999 = MOD(MOD(S1, 10000)+(ROUND((S1/100000),0) *100000), 1000000000)
				...
				*/
				maskedDataArray[0] = ((curVal % 100000000) + ((curVal / 10000000000) * 10000000000)) % 1000000000000000000;
				maskedDataArray[1] = (curVal % 100000000000000) % 1000000000000000000;
				maskedDataArray[2] = ((curVal % 10000000000) + ((curVal / 100000000000000) * 100000000000000)) % 1000000000000000000;
				maskedDataArray[3] = ((curVal % 10000) + ((curVal / 100000000) * 100000000)) % 1000000000000000000;
				maskedDataArray[4] = ((curVal / 10000) * 10000) % 1000000000000000000;
				maskedDataArray[5] = ((curVal % 100000000) + ((curVal / 100000000000000) * 100000000000000)) % 1000000000000000000;
				maskedDataArray[6] = ((curVal % 10000) + ((curVal / 10000000000) * 10000000000)) % 1000000000000000000;
				maskedDataArray[7] = (curVal % 10000000000) % 1000000000000000000;
				maskedDataArray[8] = ((curVal % 10000) + (((curVal % 100000000000000) / 100000000) * 100000000)) % 1000000000000000000;
				maskedDataArray[9] = (((curVal % 100000000000000) / 10000) * 10000) % 1000000000000000000;
				maskedDataArray[10] = ((((curVal / 10000) % 1000000) * 10000) + ((curVal / 100000000000000) * 100000000000000)) % 1000000000000000000;
				maskedDataArray[11] = ((curVal / 100000000) * 100000000) % 1000000000000000000;
				//maskedDataArray[12] = ((curVal % 10000) + ((curVal / 100000000000000) * 100000000000000)) % 1000000000000000000;
			}
			...
			public static int PowOfTen(ulong val)
			{
				int pow10 = 0;
				while (val != 0)
				{
