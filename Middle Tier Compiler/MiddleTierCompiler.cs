	...
	class MiddleTierCompiler
	{
		...
		static int Main(string[] args)
		{
			...
			try
			{
				...
				uint bufferSize;
				MiddleTierGenerator middleTierGenerator = new MiddleTierGenerator();
				middleTierGenerator.Generate(inputFilePath, fileContents, targetNamespace, buffer, out bufferSize, new ProgressIndicator());
