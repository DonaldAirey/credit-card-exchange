...
# To run this project in Visual Studio without Administrator privileges, grant access to the private key of the 'cce.darkbond.com'
# certificate to the current user.  In addition, this gives the current user permission to use the ports (80 and 443).  This script
# must be run with elevated
